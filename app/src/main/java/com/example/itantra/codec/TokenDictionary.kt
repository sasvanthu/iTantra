...
class TokenDictionary {
    ...
    private fun initializeCommonTokens() {
        ...
        val highFreqEnglish = listOf(
            ...
            "STATION", "RAILWAY", "NEAR", "ROAD", "MAIN", "SCHOOL",
            "HOME", "HOUSE", "SHELTER", "ROOM", "AREA", "TOWN", "VILLAGE",
            "PLEASE", "SEND", "BUILDING", "DAMAGED", "STUCK",
        ...
        val highFreqHindi = listOf(
            ...
            "रेलवे", "स्टेशन", "पास", "मुख्य", "सड़क",
            "कृपया", "भेजें", "इमारत", "बचाओ", "क्षतिग्रस्त"
        )
        ...
        val highFreqTamil = listOf(
            ...
            "ரயில்", "நிலையம்", "அருகில்", "முக்கிய", "சாலை",
            "விபத்து", "தண்ணீர்", "உணவு", "அனுப்புங்கள்", "கட்டிடம்",
            "சேதமடைந்துள்ளது", "காப்பாற்று"
        )
